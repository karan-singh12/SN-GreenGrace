      ...
      <div className="max-w-4xl mx-auto paper-card border border-outline-variant/30 rounded-3xl p-6 sm:p-10 shadow-sm space-y-8">
        ...
        <div className="space-y-6 text-xs sm:text-sm text-on-surface-variant leading-relaxed font-medium">
          <section className="space-y-2">
            ...
            <p>
              By accessing the SN Greens platform or ordering our fresh organic delivery service, you agree to be bound by these Terms of Service. If you do not agree, please do not use our platform or request delivery.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              SN Greens delivers freshly harvested organic fruits, vegetables, and dairy. Given the natural, chemical-free nature of organic crops:
            </p>
          ...
          <section className="space-y-2">
            ...
            <p>
              For legal inquiries or corporate terms, please contact our administrative desk at <a href="mailto:legal@sngreens.com" className="text-earthy-terracotta hover:underline">legal@sngreens.com</a>.
            </p>
          </section>
        </div>
      </div>
